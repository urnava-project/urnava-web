...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animatedElements = document.querySelectorAll('.urnava-meaning, .question-card, .central-triangle, .harmony-description, .name-intro, .leah-values-box, .vision-box, .invitation-content, .wa-row, .wa-note, .corpus-monument-head, .monument-part, .monument-summary');
